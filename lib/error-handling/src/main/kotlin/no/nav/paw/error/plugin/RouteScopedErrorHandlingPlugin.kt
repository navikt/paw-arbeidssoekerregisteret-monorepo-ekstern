...
val RouteScopedErrorHandlingPlugin: RouteScopedPlugin<RouteScopedErrorHandlingPluginConfig> = createRouteScopedPlugin(
    "RouteScopedErrorHandling",
    ::RouteScopedErrorHandlingPluginConfig
) {
    val statusPageMarker = AttributeKey<Unit>("RouteScopedErrorHandlingTriggered")
...
class RouteScopedErrorHandlingPluginConfig {

...
mapOf(
    "${rootProject.allprojects.find { it.name == "tilgangskontroll-client" }?.layout?.projectDirectory}/src/main/resources/openapi/tilgangskontroll.yaml" to generatedServerCodePackageName

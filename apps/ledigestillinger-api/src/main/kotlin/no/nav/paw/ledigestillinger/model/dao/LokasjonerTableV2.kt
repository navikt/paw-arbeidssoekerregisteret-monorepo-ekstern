...
object LokasjonerTableV2 : LongIdTable("lokasjoner_v2") {
    ...
    fun selectRowsByParentId(
        ...
        .where { LokasjonerTableV2.parentId eq parentId }
        .map { it.asLokasjonRowV2() }

    fun insert(
        parentId: Long,
        rows: Iterable<LokasjonRow>
    ) = batchInsert(rows) { row ->
        this[LokasjonerTableV2.parentId] = parentId

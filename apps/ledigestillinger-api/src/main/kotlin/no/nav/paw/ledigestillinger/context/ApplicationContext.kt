...
import no.nav.paw.ledigestillinger.config.SERVER_CONFIG
import no.nav.paw.ledigestillinger.config.ServerConfig
...
import no.nav.paw.ledigestillinger.util.createHwmKafkaConsumer

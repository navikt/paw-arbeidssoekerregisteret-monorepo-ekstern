...
(
    ...
    FOREIGN KEY (parent_id) REFERENCES stillinger_v2 (id) ON DELETE CASCADE
);

CREATE TABLE kategorier_v2
(
    id               BIGSERIAL PRIMARY KEY,
    parent_id        BIGINT       NOT NULL,
...
CREATE TABLE klassifiseringer_v2
(
    id        BIGSERIAL PRIMARY KEY,
    parent_id BIGINT       NOT NULL,

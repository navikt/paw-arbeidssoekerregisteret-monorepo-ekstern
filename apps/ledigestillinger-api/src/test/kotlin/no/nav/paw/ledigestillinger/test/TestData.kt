...
object TestData {
    ...
    val message1_1: Message<UUID, Ad> = message(
        ...
        expires = LocalDateTime.now().plusDays(14)
    )
    ...
    val message1_3: Message<UUID, Ad> = message(
        ...
        published = LocalDateTime.now().minusDays(130),
        expires = LocalDateTime.now().minusDays(100)
    )
    ...
    val message3_3: Message<UUID, Ad> = message(
        ...
        published = LocalDateTime.now().minusDays(3),
        expires = LocalDateTime.now().minusDays(31)
    )
    ...
    val message4_4: Message<UUID, Ad> = message(
        ...
        published = LocalDateTime.now().minusDays(35)
    )
    val message4_5: Message<UUID, Ad> = message(
        ...
        published = LocalDateTime.now().minusDays(40)
    )
    ...
    val message5_6: Message<UUID, Ad> = message(
        ...
        published = LocalDateTime.now().minusDays(1),
        expires = LocalDateTime.now().minusDays(50)
    )

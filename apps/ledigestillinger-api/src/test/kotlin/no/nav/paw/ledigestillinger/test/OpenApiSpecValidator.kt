...
suspend fun HttpResponse.validateAgainstOpenApiSpec(
    specValidator: OpenApiInteractionValidator = defaultSpecValidator
): HttpResponse {
...
private val defaultSpecPath = Paths.get("src/main/resources/openapi/documentation.yaml")
private val defaultSpecValidator = OpenApiInteractionValidator.createFor(defaultSpecPath.toString()).build()

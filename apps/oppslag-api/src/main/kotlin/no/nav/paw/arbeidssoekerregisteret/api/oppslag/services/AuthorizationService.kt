...
import no.nav.poao_tilgang.client.NavAnsattNavIdentSkrivetilgangTilEksternBrukerPolicyInput
        ...
        val policyRequests = identiteter
            .map {
                if (action == Action.WRITE) {
                    NavAnsattNavIdentSkrivetilgangTilEksternBrukerPolicyInput(bruker.ident, it.verdi)
                } else {
                    NavAnsattNavIdentLesetilgangTilEksternBrukerPolicyInput(bruker.ident, it.verdi)
                }
            }

...
fun KStream<Long, out SpecificRecord>.saveToStoreForwardIfComplete(type: KClass<out BaseStateStoreSave>, storeName: String, registry: PrometheusMeterRegistry): KStream<Long, ArenaArbeidssokerregisterTilstand> {
    val processBuilder = {
        when (type) {
